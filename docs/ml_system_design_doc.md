...
- Пилот считается успешным, если достигнуты следующие показатели качества  
    - f1 > 0.8  
    - Сокращенное время, которое затрачивает работник предприятия на мнониторинг оборудования  
#### 3.3. Подготовка пилота  
Без сжатия ВР на сигнал с одного устройста, собранного за 24 часа, уходит 18 минут, при сжатии ВР - 14-18 секунд.  
